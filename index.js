// navbar & hero consultation button
...
$(document).ready(function () {
    $("#entryForm").submit(function (e) {
        ...
        $("#entryFormContent").html("<p>Thank you for contacting us! We will contact you as soon as possible to answer your questions and with available consultation dates.</p>");
